...
parser.add_argument('--use_only_train2014', type=int, default=0, choices=[0, 1],
...
if args.use_only_train2014 == 0:
    ...
    annots_list, questions_list, labels, tokens, dropped_ans = process_qa(
        train_annots['annotations'] + val_annots['annotations'],
        train_questions['questions'] + val_questions['questions'], args.n_ans
    )

    train_annots = annots_list[:seperator_idx-dropped_ans]
    val_annots = annots_list[seperator_idx-dropped_ans:]
    ...
    annots_list, questions_list, labels, tokens, dropped_ans = process_qa(
        train_annots['annotations'], train_questions['questions'], args.n_ans
    )
...
if args.use_only_train2014 == 0:
    val_dataset = VQADataset(
        ...
        labels, tokens, transforms, 'COCO_val2014_'
    )
else:
    val_dataset = VQADataset(
        val_images_dir, val_annots, val_questions,
